...
//!
//! Validates the runtime feature detection system including
//! compile-time flags and environment variable overrides.
//!
//! NOTE: Tests that modify environment variables use a global lock
...
// Happy Path Tests - Constructor Behavior
...
// Happy Path Tests - Compile-Time Feature Detection
